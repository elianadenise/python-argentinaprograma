...
import os;
import csv;
os.chdir('./05-manipulacion-de-archivos/ejercicio-2-bis-mal');

# **a**. Leer el archivo y explorarlo
arboles = []
with open('arbolado-en-espacios-verdes.csv', errors="ignore") as f:
    filas = csv.reader(f)
